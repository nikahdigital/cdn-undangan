...
$(document).ready(function () {
    ...
    $('#loader-wrapper').css('background', 'url("assets/img/cover.jpg") center center');
    ...
    $("#brideImage").css("background-image", `url('${coupleData.bride.image}')`);
    $("#groomImage").css("background-image", `url('${coupleData.groom.image}')`);
    ...
    $('#penutupImgae').attr('src', 'assets/img/profil.jpg');
