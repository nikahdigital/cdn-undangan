...
const  coupleNames ="Dewi & Dary";
  ...
  const future = new Date("2026-06-28T08:00:00").getTime();
   ...
   //the weding 1
   $('.image-container').attr('src', 'assets/img/profil.jpg');
   $('.image-container2').attr('src', 'assets/img/profil.jpg');
    ...
    //akad
    $('.title-akad').text('Akad Nikah');
    $('.akad-cover').attr('src', 'assets/img/cover.jpg');
    $('.akad-date').text('31');
    $('.akad-time').html('Minggu<br>Desember 2023');
    $('.akad-jam').text('08.00 WIB');
    $('.akad-location-title').text('LOKASI ACARA');
    $('.event-address').text('Kediaman Mempelai Wanita');
    $('.akad-jalan').text('Jl Kaji 9 B, Dki Jakarta');
    $('.akad-map').attr('href', 'https://maps.google.com').text('Google Maps');

 
    //Resepsi
    $('.resepsi-title').text('Resepsi');
    $('.resepsi-cover').attr('src', 'assets/img/cover.jpg');
    $('.resepsi-date').text('31');
    $('.resepsi-time').html('Minggu<br>Desember 2023');
    $('.resepsi-jam').text('08.00 WIB');
    $('.resepsi-location-title').text('LOKASI ACARA');
    $('.resepsi-address').text('Kediaman Mempelai Pria');
    $('.resepsi-jalan').text('Jl Kaji 9 B, Dki Jakarta');
    $('.resepsi-map').attr('href', 'https://maps.google.com').text('Google Maps');
  ...
  <a href="${imagePath}" class="gallery-item" data-lg-size="1600-2400" data-sub-html="The Wedding Dewi & Dary">
    <img loading="lazy"  src="${imagePath}" alt="The Wedding Dewi & Dary">
  </a>
`;
      ...
      const html = `
        <div class="cd-timeline__block">
          ...
          <div class="cd-timeline__content text-component aos-item" data-aos="zoom-in-right" data-aos-duration="1000">
            ...
            <div class="pic"><img loading="lazy"  loading="lazy"src="${story.image}" class="img-fluid" alt=""></div>
